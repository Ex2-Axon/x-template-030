    ...
    <>
      <main className="app-container">
        <header className="hero">
          <div className="badge">ONLINE — 1989</div>
          <h1>AESTHETIC</h1>
          <p className="subtitle">A E S T H E T I C &nbsp; V I B E S</p>

          <button className="btn" onClick={() => setCount((c) => c + 1)}>
            FEEL_ <CounterNum value={count} />
          </button>

          {/* Coffee Machine (adapted from selected component) */}
